...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="page-header">
            <h3>导师分配权限管理/<a href="./${sessionScope.pathCode}/selectTutorPower2.do">成绩汇总权限</a></h3>
        </div>
                    ...
                    <tr>
                       ...
                       <td>
                            <div class="visible-md visible-lg hidden-sm hidden-xs">
                                <a href="./${sessionScope.pathCode}/updateTutorInfoA.do?tutorID=${tutor.tutorID}"data-toggle="modal" data-target="#pwdM">
