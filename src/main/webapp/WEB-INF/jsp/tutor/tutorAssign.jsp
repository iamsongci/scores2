...
<script type="text/javascript">
	function look(proID, proName) {
		var url="./${sessionScope.pathCode}/tutorList.do?proID=" + proID + "&proName=" +proName;
		url=encodeURI(url);
		url=encodeURI(url); 
					...
					<c:forEach items="${proList}" var="pro">
						<tbody>
							<tr>
								...
								<th><button type="button" class="btn btn-info" onclick="look('${pro.projectID}', '${pro.projectName}')">进入</button></th>
							</tr>
						</tbody>
					</c:forEach>
				</table>
