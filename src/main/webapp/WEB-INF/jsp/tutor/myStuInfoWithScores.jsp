					...
					<c:forEach items="${info}" var="info">
						<tbody>
							<tr>
								...
								<td>
									<div class="visible-md visible-lg hidden-sm hidden-xs" data-target="#updateScore" data-toggle="modal">
										<a onclick="init('${info.index}')"> 
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="padding: 10px 30px 10px 30px">
						<input type="button" value="导出学生信息" onclick="downloadWithStuInfo()"/>
					</div>
					<div style="padding: 10px 30px 10px 30px">
						<h4 ><span class="label label-warning">Warning</span>导出格式: 导出后在分数栏填写分数,请勿改动表格</h4>
						<img src="./img/type.png" class="img-responsive" alt="Responsive image">
					</div>
				</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div style="padding: 10px 30px 10px 30px">
						<h4 ><span class="label label-warning">Warning</span>  导入格式: 若成绩栏为空, 则学生成绩为0</h4>
						<img src="./img/type.png" class="img-responsive" alt="Responsive image">
					</div>
				</div>
				<div class="modal-footer">
